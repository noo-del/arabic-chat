 ...
 */
export const listChatRooms = async ( options?: Parameters<typeof customFetch>[1]): Promise<ChatRoom[]> => {
...
export const getListChatMessagesUrl = (roomId: string,) => {
 ...
 */
export const listChatMessages = async (roomId: string, options?: Parameters<typeof customFetch>[1]): Promise<ChatMessage[]> => {
...
export const getListChatMessagesQueryKey = (roomId: string,) => {
    return [
...
export const getListChatMessagesQueryOptions = <TData = Awaited<ReturnType<typeof listChatMessages>>, TError = ErrorType<unknown>>(roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listChatMessages>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListChatMessagesQueryKey(roomId);
   ...
   return  { queryKey, queryFn, enabled: roomId !== null && roomId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listChatMessages>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useListChatMessages<TData = Awaited<ReturnType<typeof listChatMessages>>, TError = ErrorType<unknown>>(
 roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listChatMessages>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
